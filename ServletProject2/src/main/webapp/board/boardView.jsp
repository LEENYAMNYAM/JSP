...
<div class = "container mt-3">
	<label for="msg">댓글작성:</label>
  	<textarea class="form-control" id="msg" name="msg" placeholder="Content goes here" rows=2></textarea>
	<button class="btn btn-success btn-sm mt-3" id="btnComment">Comment Whrite</button>
...
$("#btnComment").click(function(){
	...
	.done(function(resp){
		if(resp.trim()==1){
			alert("로그인하세요")
			locatrion.href ="/member/login.do";
		}else{
			alert("댓글 추가 성공")
			$("#msg").val("")
			init()
